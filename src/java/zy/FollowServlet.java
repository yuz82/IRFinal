...
public class FollowServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String is_following_str = request.getParameter("is_following");
        Boolean is_following = Boolean.valueOf(is_following_str);
        ...
        follow http = new follow();
        http.sendPut(post_id,access_token,is_following);
